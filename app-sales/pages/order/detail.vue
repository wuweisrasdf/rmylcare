<template>
    ...
    <view class="detail-btn" v-if="[6,7].includes(currentStatusId)">
	...
	export default {
		...
		methods: {
			async init() {
				...
				//（1-已签，2-未签，3-取消，4-终止）
        // console.log(1111, this.orderId)
				const res = await api.contractDetail({id: this.orderId});
				if (res.code == 200) {
